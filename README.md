...
- IS_ENTERPRISE - will install the Enterprise version on top of the community version if you set it to _True_, set it to _False_ if you want the community version of Odoo.
